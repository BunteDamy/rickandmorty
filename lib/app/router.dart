...
import 'package:rickandmorty/views/screens/location_view/locations_view.dart';
import 'package:rickandmorty/views/screens/residents_view/resident_viewmodel.dart';
import 'package:rickandmorty/views/screens/residents_view/residents_view.dart';
...
import 'package:rickandmorty/views/screens/section_view/sections_viewmodel.dart';
              ...
              routes: [
                GoRoute(
                  ...
                  builder: (context, state) => ChangeNotifierProvider(
                    ...
                    child: SectionCharactersView(episodeModel: state.extra as EpisodeModel),
                  ),
                ),
              ]
            ),
